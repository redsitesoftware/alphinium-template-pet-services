 ...
 *
 * Demo mode (no API_URL): returns the static groomer.reviews array with mock pagination.
 *
 ...
 */
export async function getGroomerReviews(groomerId, page = 1, groomerFallback = null) {
  if (!API_URL) {
