...
// Demo-mode mock appointments for today
 ...
 *
 * Demo mode (no API_URL): returns a hardcoded set of mock appointments for today
 * so the admin UI is fully usable without a backend.
 *
 * @param {string} date - ISO date string 'YYYY-MM-DD'
 * @param {string|null} authToken
 * @returns {Promise<object[]>} Array of normalised appointment objects.
 */
 ...
 *
 * Demo mode: returns the booking id with the updated status immediately.
 *
 * @param {string} bookingId
 * @param {'confirmed'|'completed'|'no-show'} status
 * @param {string|null} authToken
 * @returns {Promise<object>} Updated normalised appointment object.
 */
